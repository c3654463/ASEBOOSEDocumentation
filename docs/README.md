...
#### 6 Basic drawing commands of the library are implemented (2)
	...
	Removed all the restrictions and tested with the provided unrestricted drawing program.
